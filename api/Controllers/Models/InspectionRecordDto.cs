...
public class InspectionRecordDto(InspectionRecord record, IBlobStorageService blobService)
{
    ...
    public Uri SASToken { get; set; } = blobService.CreateUserDelegationSASUri(
    ...
    public List<AnalysisDto> Analyses { get; set; } = [.. record.Analyses.Select((a) => new AnalysisDto(a, blobService))];
